...
const controlRecipes = async function () {
	try {
		...
		// 01) Updating the bookmarks view
...
const controlAddRecipe = async function (newRecipe) {
	try {
		...
		// Change ID in the URL for that we can use history API
...
// Code that want's to react: SUBSCRIBER (Handling events)
const init = function () {
